...
class CSP:
    ...
    # the original used a recursive function, in my opinion this one looks better
...
# The original used a function from util files and was harder to understand
...
# the original used a function count and a list, in my opinion it is faster to
...
# we should notice that with MRV it works good since the partial initial state
